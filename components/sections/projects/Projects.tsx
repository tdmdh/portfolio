...
const projects: Project[] = [
  ...
  {
    title: "Lornian",
    description: "An AI-Native Workspace with pre built microservices architecture. Built with Go, gRPC, and PostgreSQL.",
    fullDescription: "An AI-Native Workspace that leverages the power of artificial intelligence to enhance productivity and creativity. Built with Go for high performance, gRPC for efficient inter-service communication, and PostgreSQL for reliable data persistence. Features include multi-tenant support, real-time content synchronization, advanced caching strategies, and a flexible content modeling system.",
    status: "in-progress",
    type: "desktop",
    link: "https://lornian.com",
    linkText: "View Site",
