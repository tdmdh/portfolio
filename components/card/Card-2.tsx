  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-[#fffcf2] relative group/card dark:hover:shadow-2xl dark:hover:shadow-[#403d39]/[0.1] dark:bg-[#252422] dark:border-[#ccc5b9]/[0.2] border-[#252422]/[0.1] w-auto sm:w-[30rem] h-auto rounded-3xl p-6 border">
        ...
        >
          Een entertainment website voor een fictief ruimtevaartbedrijf.
        </CardItem>
        <CardItem translateZ="100" className="w-full mt-4">
          <Image
            src="/projects/mtm.png"
            height="1000"
            width="1000"
        ...
        <div className="flex justify-between items-center mt-20">
          ...
          >
          <Link
            href="https://101726.stu.sd-lab.nl/missiontomars/web/home.html?classId=0445f3bd-f90e-4275-b9e5-b8b970bdc244&assignmentId=62127c6a-6227-4046-ae39-1fdb140524a4&submissionId=d14b8213-dca9-a08b-ed43-f7c5ae80cbb4"
            >
            View details
          </Link>
          </CardItem>
